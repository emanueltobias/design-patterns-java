package com.emanueltobias.builder.meal.fluent;

import com.emanueltobias.builder.meal.fluent.model.FastFoodMeal;
import com.emanueltobias.builder.meal.fluent.model.builder.FastFoodMealBuilder;
