package com.emanueltobias.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import com.emanueltobias.command.alexa.before.lights.PhillipsHueLight;
import com.emanueltobias.command.alexa.before.lights.XiaomiLight;
